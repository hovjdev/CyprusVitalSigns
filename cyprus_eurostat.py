...
def plot_df(df, title,  index, output_dir):
    ...
    # data source
    plt.text(0., -.12, 'data: https://ec.europa.eu/', ha='left', va='center', transform=ax.transAxes, fontsize=15)
...
if __name__ == "__main__":
    ...
    metadata = {
        ...
        'tour_occ_nim' : {
                ...
                'unit': ""},
        'tour_dem_extot' : {
                'filters': {'GEO': ['CY'], 'UNIT': ['EUR'], 'FREQ': ['A'], 'EXPEND':['TOTAL'], 'PARTNER':['WORLD'], 'DURANTION':['N_GE1']}, 
                'title':"Nights spent at tourist accommodation establishments (monthly data)",
                'title_short':"Nights spent",
                'unit': ""}
    }
